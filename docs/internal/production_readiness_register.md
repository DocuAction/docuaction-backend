...
| 8 | **SAM.gov credential and routing** | COR / GOVERNMENT INPUT · **affects every review** | No credential held. Every entity currently carries a SAM.gov source limitation. AGT has requested a Government route to access. Reviews can proceed with the limitation disclosed; they are weaker for it. |
