...
| Behaviour | Concurrent source probes; Jaro-Winkler name similarity; USPS Pub 28 address normalization; NPI format + Luhn validation; **fail-closed** — an unavailable source is recorded as unavailable, never clean |
...
| USPS | `apis.usps.com` v3 | OAuth 2.0 | Address standardization |
