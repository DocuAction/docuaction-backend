...
| FR-T3-014 | The system shall verify addresses via the USPS Address APIs v3 using OAuth 2.0. | 3.1 | T | CURRENT |
...
| NFR-IR-004 | USPS Address APIs v3 (`apis.usps.com`) | OAuth 2.0 | CURRENT |
